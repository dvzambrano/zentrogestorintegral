...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-12-2020 a las 03:23:56
...
CREATE TABLE `sf_guard_login_attempt` (
  `id` bigint(20) NOT NULL,
...
CREATE TABLE `sf_guard_user_password` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) DEFAULT NULL,
  `algorithm` varchar(128) NOT NULL DEFAULT 'sha1',
  `salt` varchar(128) DEFAULT NULL,
...
CREATE TABLE `zab_entityuserrelation` (
...
CREATE TABLE `zab_moduledependencyrelation` (
...
CREATE TABLE `zab_modulepermission` (
  `module_id` bigint(20) NOT NULL,
  `permission_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `zgctr_activity`
--

CREATE TABLE `zgctr_activity` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL
...
--
-- Volcado de datos para la tabla `zgctr_activity`
--
...
--
-- Estructura de tabla para la tabla `zgctr_contract`
--

CREATE TABLE `zgctr_contract` (
  `id` bigint(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `zgctr_contractstatus`
--

CREATE TABLE `zgctr_contractstatus` (
  `id` bigint(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `zgctr_contractstatusrelation`
--

CREATE TABLE `zgctr_contractstatusrelation` (
...
--
-- Estructura de tabla para la tabla `zgctr_contracttype`
--

CREATE TABLE `zgctr_contracttype` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL
...
--
-- Volcado de datos para la tabla `zgctr_contracttype`
--
...
--
-- Estructura de tabla para la tabla `zgctr_documenttype`
--

CREATE TABLE `zgctr_documenttype` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL
...
--
-- Volcado de datos para la tabla `zgctr_documenttype`
--
...
--
-- Estructura de tabla para la tabla `zgctr_entitytype`
--

CREATE TABLE `zgctr_entitytype` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `zgctr_entitytype`
--
...
--
-- Estructura de tabla para la tabla `zgctr_format`
--

CREATE TABLE `zgctr_format` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `zgctr_location`
--

CREATE TABLE `zgctr_location` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `zgctr_location`
--
...
--
-- Estructura de tabla para la tabla `zgctr_nationality`
--

CREATE TABLE `zgctr_nationality` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL
...
--
-- Volcado de datos para la tabla `zgctr_nationality`
--
...
--
-- Estructura de tabla para la tabla `zgctr_paymentinstrument`
--

CREATE TABLE `zgctr_paymentinstrument` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL
...
--
-- Volcado de datos para la tabla `zgctr_paymentinstrument`
--
...
--
-- Estructura de tabla para la tabla `zgctr_reclamationstatus`
--

CREATE TABLE `zgctr_reclamationstatus` (
  `id` bigint(20) NOT NULL,
  `customcolor` text DEFAULT NULL,
  `calendarid` bigint(20) DEFAULT NULL,
  `entityid` bigint(20) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `zgctr_reclamationstatusrelation`
--

CREATE TABLE `zgctr_reclamationstatusrelation` (
  `fromstatus_id` bigint(20) NOT NULL,
  `tostatus_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `zgctr_reclamationtype`
--

CREATE TABLE `zgctr_reclamationtype` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL
...
--
-- Volcado de datos para la tabla `zgctr_reclamationtype`
--
...
--
-- Estructura de tabla para la tabla `zgfact_contractproductrelation`
--

CREATE TABLE `zgfact_contractproductrelation` (
...
--
-- Estructura de tabla para la tabla `zgfact_invoice`
--

CREATE TABLE `zgfact_invoice` (
  `id` bigint(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `zgfact_invoiceitem`
--

CREATE TABLE `zgfact_invoiceitem` (
  `id` bigint(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `zgfact_invoicetaxrelation`
--

CREATE TABLE `zgfact_invoicetaxrelation` (
...
--
-- Estructura de tabla para la tabla `zgfact_tax`
--

CREATE TABLE `zgfact_tax` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `zgfact_tax`
--
...
--
-- Estructura de tabla para la tabla `zginv_product`
--

CREATE TABLE `zginv_product` (
  `id` bigint(20) NOT NULL,
  `amount` decimal(18,2) NOT NULL,
  `currencyid` bigint(20) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `zginv_producttaxrelation`
--

CREATE TABLE `zginv_producttaxrelation` (
  `productid` bigint(20) NOT NULL,
  `taxid` bigint(20) NOT NULL,
  `amount` decimal(18,2) NOT NULL,
  `fixed` tinyint(1) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `zi1_position`
--

CREATE TABLE `zi1_position` (
  `id` bigint(20) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(130) NOT NULL,
  `comment` text DEFAULT NULL,
...
CREATE TABLE `zmc_costcenterelementrelation` (
...
CREATE TABLE `zmc_elementelementrelation` (
...
--
-- Indices de la tabla `sf_guard_forgot_password`
--
...
--
-- Indices de la tabla `sf_guard_login_attempt`
--
ALTER TABLE `sf_guard_login_attempt`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `sf_guard_user_password`
--
...
--
-- Indices de la tabla `zab_calendar`
--
ALTER TABLE `zab_calendar`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zab_contacttype`
--
ALTER TABLE `zab_contacttype`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zab_entity`
--
ALTER TABLE `zab_entity`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `parentid_idx` (`parentid`),
  ADD KEY `locationid_idx` (`locationid`),
  ADD KEY `nationalityid_idx` (`nationalityid`),
  ADD KEY `entitytypeid_idx` (`entitytypeid`);

--
-- Indices de la tabla `zab_entityuserrelation`
--
ALTER TABLE `zab_entityuserrelation`
  ADD PRIMARY KEY (`entity_id`,`sf_guard_user_id`),
  ADD KEY `zab_entityuserrelation_sf_guard_user_id_sf_guard_user_id` (`sf_guard_user_id`);

--
-- Indices de la tabla `zab_event`
--
ALTER TABLE `zab_event`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `calendarid_idx` (`calendarid`),
  ADD KEY `reminderid_idx` (`reminderid`);

--
-- Indices de la tabla `zab_file`
--
ALTER TABLE `zab_file`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zab_metadata`
--
ALTER TABLE `zab_metadata`
  ADD PRIMARY KEY (`name`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Indices de la tabla `zab_module`
--
...
--
-- Indices de la tabla `zab_moduledependencyrelation`
--
ALTER TABLE `zab_moduledependencyrelation`
  ADD PRIMARY KEY (`module_id`,`dependency_id`),
  ADD KEY `zab_moduledependencyrelation_dependency_id_zab_module_id` (`dependency_id`);

--
-- Indices de la tabla `zab_modulepermission`
--
ALTER TABLE `zab_modulepermission`
  ADD PRIMARY KEY (`module_id`,`permission_id`),
  ADD KEY `zab_modulepermission_permission_id_sf_guard_permission_id` (`permission_id`);

--
-- Indices de la tabla `zab_note`
--
...
--
-- Indices de la tabla `zab_person`
--
ALTER TABLE `zab_person`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `sf_guard_user_id_idx` (`sf_guard_user_id`),
  ADD KEY `positionid_idx` (`positionid`);

--
-- Indices de la tabla `zab_reminder`
--
ALTER TABLE `zab_reminder`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_activity`
--
ALTER TABLE `zgctr_activity`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_contract`
--
ALTER TABLE `zgctr_contract`
  ADD PRIMARY KEY (`id`),
  ADD KEY `eventid_idx` (`eventid`),
  ADD KEY `contracttypeid_idx` (`contracttypeid`),
  ADD KEY `contractstatusid_idx` (`contractstatusid`),
  ADD KEY `areaid_idx` (`areaid`),
  ADD KEY `created_by_idx` (`created_by`),
  ADD KEY `providerid_idx` (`providerid`),
  ADD KEY `provideruserid_idx` (`provideruserid`),
  ADD KEY `clientid_idx` (`clientid`),
  ADD KEY `clientuserid_idx` (`clientuserid`);

--
-- Indices de la tabla `zgctr_contractstatus`
--
ALTER TABLE `zgctr_contractstatus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `calendarid_idx` (`calendarid`);

--
-- Indices de la tabla `zgctr_contractstatusrelation`
--
ALTER TABLE `zgctr_contractstatusrelation`
  ADD PRIMARY KEY (`fromstatus_id`,`tostatus_id`),
  ADD KEY `zgctr_contractstatusrelation_tostatus_id_zgctr_contractstatus_id` (`tostatus_id`);

--
-- Indices de la tabla `zgctr_contracttype`
--
ALTER TABLE `zgctr_contracttype`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_documenttype`
--
ALTER TABLE `zgctr_documenttype`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_entitytype`
--
ALTER TABLE `zgctr_entitytype`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_format`
--
ALTER TABLE `zgctr_format`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_location`
--
ALTER TABLE `zgctr_location`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `parentid_idx` (`parentid`);

--
-- Indices de la tabla `zgctr_nationality`
--
ALTER TABLE `zgctr_nationality`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_paymentinstrument`
--
ALTER TABLE `zgctr_paymentinstrument`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgctr_reclamationstatus`
--
ALTER TABLE `zgctr_reclamationstatus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `calendarid_idx` (`calendarid`);

--
-- Indices de la tabla `zgctr_reclamationstatusrelation`
--
ALTER TABLE `zgctr_reclamationstatusrelation`
  ADD PRIMARY KEY (`fromstatus_id`,`tostatus_id`),
  ADD KEY `ztzi` (`tostatus_id`);

--
-- Indices de la tabla `zgctr_reclamationtype`
--
ALTER TABLE `zgctr_reclamationtype`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zgfact_contractproductrelation`
--
ALTER TABLE `zgfact_contractproductrelation`
  ADD PRIMARY KEY (`productid`,`contractid`),
  ADD KEY `zgfact_contractproductrelation_contractid_zgctr_contract_id` (`contractid`);

--
-- Indices de la tabla `zgfact_invoice`
--
ALTER TABLE `zgfact_invoice`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contractid_idx` (`contractid`),
  ADD KEY `comprobantid_idx` (`comprobantid`);

--
-- Indices de la tabla `zgfact_invoiceitem`
--
ALTER TABLE `zgfact_invoiceitem`
  ADD PRIMARY KEY (`id`),
  ADD KEY `invoiceid_idx` (`invoiceid`),
  ADD KEY `transactionid_idx` (`transactionid`);

--
-- Indices de la tabla `zgfact_invoicetaxrelation`
--
ALTER TABLE `zgfact_invoicetaxrelation`
  ADD PRIMARY KEY (`invoiceid`,`taxid`),
  ADD KEY `currencyid_idx` (`currencyid`),
  ADD KEY `zgfact_invoicetaxrelation_taxid_zgfact_tax_id` (`taxid`);

--
-- Indices de la tabla `zgfact_tax`
--
ALTER TABLE `zgfact_tax`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zginv_product`
--
ALTER TABLE `zginv_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `currencyid_idx` (`currencyid`),
  ADD KEY `elementid_idx` (`elementid`);

--
-- Indices de la tabla `zginv_producttaxrelation`
--
ALTER TABLE `zginv_producttaxrelation`
  ADD PRIMARY KEY (`productid`,`taxid`),
  ADD KEY `currencyid_idx` (`currencyid`),
  ADD KEY `zginv_producttaxrelation_taxid_zgfact_tax_id` (`taxid`);

--
-- Indices de la tabla `zi1_position`
--
ALTER TABLE `zi1_position`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zmc_account`
--
ALTER TABLE `zmc_account`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `parentid_idx` (`parentid`),
  ADD KEY `costcenterid_idx` (`costcenterid`),
  ADD KEY `elementid_idx` (`elementid`);

--
-- Indices de la tabla `zmc_closeup`
--
ALTER TABLE `zmc_closeup`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zmc_comprobant`
--
ALTER TABLE `zmc_comprobant`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zmc_costcenter`
--
...
--
-- Indices de la tabla `zmc_costcenterelementrelation`
--
ALTER TABLE `zmc_costcenterelementrelation`
  ADD PRIMARY KEY (`costcenter_id`,`element_id`),
  ADD KEY `zmc_costcenterelementrelation_element_id_zmc_element_id` (`element_id`);

--
-- Indices de la tabla `zmc_currency`
--
ALTER TABLE `zmc_currency`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indices de la tabla `zmc_element`
--
ALTER TABLE `zmc_element`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `umid_idx` (`umid`);

--
-- Indices de la tabla `zmc_elementelementrelation`
--
ALTER TABLE `zmc_elementelementrelation`
  ADD PRIMARY KEY (`from_id`,`to_id`),
  ADD KEY `zmc_elementelementrelation_to_id_zmc_element_id` (`to_id`);

--
-- Indices de la tabla `zmc_transaction`
--
...
--
-- Indices de la tabla `zmc_umumrelation`
--
ALTER TABLE `zmc_umumrelation`
  ADD PRIMARY KEY (`from_id`,`to_id`),
  ADD KEY `zmc_umumrelation_to_id_zmc_um_id` (`to_id`);
...
--
-- AUTO_INCREMENT de la tabla `sf_guard_forgot_password`
--
ALTER TABLE `sf_guard_forgot_password`
...
--
-- AUTO_INCREMENT de la tabla `sf_guard_login_attempt`
--
ALTER TABLE `sf_guard_login_attempt`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `sf_guard_remember_key`
--
ALTER TABLE `sf_guard_remember_key`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `sf_guard_user_password`
--
ALTER TABLE `sf_guard_user_password`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zab_calendar`
--
ALTER TABLE `zab_calendar`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `zab_contacttype`
--
ALTER TABLE `zab_contacttype`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `zab_entity`
--
ALTER TABLE `zab_entity`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;

--
-- AUTO_INCREMENT de la tabla `zab_event`
--
ALTER TABLE `zab_event`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `zab_file`
--
ALTER TABLE `zab_file`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zab_module`
--
ALTER TABLE `zab_module`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de la tabla `zab_note`
--
ALTER TABLE `zab_note`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zab_person`
--
ALTER TABLE `zab_person`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `zab_reminder`
--
ALTER TABLE `zab_reminder`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `zgctr_activity`
--
ALTER TABLE `zgctr_activity`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;

--
-- AUTO_INCREMENT de la tabla `zgctr_contract`
--
ALTER TABLE `zgctr_contract`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zgctr_contractstatus`
--
ALTER TABLE `zgctr_contractstatus`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zgctr_contracttype`
--
ALTER TABLE `zgctr_contracttype`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `zgctr_documenttype`
--
ALTER TABLE `zgctr_documenttype`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `zgctr_entitytype`
--
ALTER TABLE `zgctr_entitytype`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `zgctr_format`
--
ALTER TABLE `zgctr_format`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zgctr_location`
--
ALTER TABLE `zgctr_location`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;

--
-- AUTO_INCREMENT de la tabla `zgctr_nationality`
--
ALTER TABLE `zgctr_nationality`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `zgctr_paymentinstrument`
--
ALTER TABLE `zgctr_paymentinstrument`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `zgctr_reclamationstatus`
--
ALTER TABLE `zgctr_reclamationstatus`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zgctr_reclamationtype`
--
ALTER TABLE `zgctr_reclamationtype`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `zgfact_invoice`
--
ALTER TABLE `zgfact_invoice`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zgfact_invoiceitem`
--
ALTER TABLE `zgfact_invoiceitem`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zgfact_tax`
--
ALTER TABLE `zgfact_tax`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `zginv_product`
--
ALTER TABLE `zginv_product`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zi1_position`
--
ALTER TABLE `zi1_position`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_account`
--
ALTER TABLE `zmc_account`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_closeup`
--
ALTER TABLE `zmc_closeup`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_comprobant`
--
ALTER TABLE `zmc_comprobant`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_costcenter`
--
ALTER TABLE `zmc_costcenter`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_currency`
--
ALTER TABLE `zmc_currency`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `zmc_element`
--
ALTER TABLE `zmc_element`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_transaction`
--
ALTER TABLE `zmc_transaction`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `zmc_um`
--
ALTER TABLE `zmc_um`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `zab_entity`
  ADD CONSTRAINT `zab_entity_entitytypeid_zgctr_entitytype_id` FOREIGN KEY (`entitytypeid`) REFERENCES `zgctr_entitytype` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zab_entity_locationid_zgctr_location_id` FOREIGN KEY (`locationid`) REFERENCES `zgctr_location` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zab_entity_nationalityid_zgctr_nationality_id` FOREIGN KEY (`nationalityid`) REFERENCES `zgctr_nationality` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `zab_person`
  ADD CONSTRAINT `zab_person_positionid_zi1_position_id` FOREIGN KEY (`positionid`) REFERENCES `zi1_position` (`id`) ON DELETE CASCADE,
...
--
-- Filtros para la tabla `zgctr_contract`
--
ALTER TABLE `zgctr_contract`
  ADD CONSTRAINT `zgctr_contract_areaid_zmc_costcenter_id` FOREIGN KEY (`areaid`) REFERENCES `zmc_costcenter` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `zgctr_contract_clientid_zab_entity_id` FOREIGN KEY (`clientid`) REFERENCES `zab_entity` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contract_clientuserid_sf_guard_user_id` FOREIGN KEY (`clientuserid`) REFERENCES `sf_guard_user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contract_contractstatusid_zgctr_contractstatus_id` FOREIGN KEY (`contractstatusid`) REFERENCES `zgctr_contractstatus` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `zgctr_contract_contracttypeid_zgctr_contracttype_id` FOREIGN KEY (`contracttypeid`) REFERENCES `zgctr_contracttype` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contract_created_by_zab_person_id` FOREIGN KEY (`created_by`) REFERENCES `zab_person` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contract_eventid_zab_event_id` FOREIGN KEY (`eventid`) REFERENCES `zab_event` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contract_providerid_zab_entity_id` FOREIGN KEY (`providerid`) REFERENCES `zab_entity` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contract_provideruserid_sf_guard_user_id` FOREIGN KEY (`provideruserid`) REFERENCES `sf_guard_user` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgctr_contractstatus`
--
ALTER TABLE `zgctr_contractstatus`
  ADD CONSTRAINT `zgctr_contractstatus_calendarid_zab_calendar_id` FOREIGN KEY (`calendarid`) REFERENCES `zab_calendar` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgctr_contractstatusrelation`
--
ALTER TABLE `zgctr_contractstatusrelation`
  ADD CONSTRAINT `zfzi` FOREIGN KEY (`fromstatus_id`) REFERENCES `zgctr_contractstatus` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgctr_contractstatusrelation_tostatus_id_zgctr_contractstatus_id` FOREIGN KEY (`tostatus_id`) REFERENCES `zgctr_contractstatus` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgctr_location`
--
ALTER TABLE `zgctr_location`
  ADD CONSTRAINT `zgctr_location_parentid_zgctr_location_id` FOREIGN KEY (`parentid`) REFERENCES `zgctr_location` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgctr_reclamationstatus`
--
ALTER TABLE `zgctr_reclamationstatus`
  ADD CONSTRAINT `zgctr_reclamationstatus_calendarid_zab_calendar_id` FOREIGN KEY (`calendarid`) REFERENCES `zab_calendar` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgctr_reclamationstatusrelation`
--
ALTER TABLE `zgctr_reclamationstatusrelation`
  ADD CONSTRAINT `zfzi_1` FOREIGN KEY (`fromstatus_id`) REFERENCES `zgctr_reclamationstatus` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ztzi` FOREIGN KEY (`tostatus_id`) REFERENCES `zgctr_reclamationstatus` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgfact_contractproductrelation`
--
ALTER TABLE `zgfact_contractproductrelation`
  ADD CONSTRAINT `zgfact_contractproductrelation_contractid_zgctr_contract_id` FOREIGN KEY (`contractid`) REFERENCES `zgctr_contract` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgfact_contractproductrelation_productid_zginv_product_id` FOREIGN KEY (`productid`) REFERENCES `zginv_product` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgfact_invoice`
--
ALTER TABLE `zgfact_invoice`
  ADD CONSTRAINT `zgfact_invoice_comprobantid_zmc_comprobant_id` FOREIGN KEY (`comprobantid`) REFERENCES `zmc_comprobant` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgfact_invoice_contractid_zgctr_contract_id` FOREIGN KEY (`contractid`) REFERENCES `zgctr_contract` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgfact_invoiceitem`
--
ALTER TABLE `zgfact_invoiceitem`
  ADD CONSTRAINT `zgfact_invoiceitem_invoiceid_zgfact_invoice_id` FOREIGN KEY (`invoiceid`) REFERENCES `zgfact_invoice` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgfact_invoiceitem_transactionid_zmc_transaction_id` FOREIGN KEY (`transactionid`) REFERENCES `zmc_transaction` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zgfact_invoicetaxrelation`
--
ALTER TABLE `zgfact_invoicetaxrelation`
  ADD CONSTRAINT `zgfact_invoicetaxrelation_currencyid_zmc_currency_id` FOREIGN KEY (`currencyid`) REFERENCES `zmc_currency` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgfact_invoicetaxrelation_invoiceid_zgfact_invoice_id` FOREIGN KEY (`invoiceid`) REFERENCES `zgfact_invoice` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zgfact_invoicetaxrelation_taxid_zgfact_tax_id` FOREIGN KEY (`taxid`) REFERENCES `zgfact_tax` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zginv_product`
--
ALTER TABLE `zginv_product`
  ADD CONSTRAINT `zginv_product_currencyid_zmc_currency_id` FOREIGN KEY (`currencyid`) REFERENCES `zmc_currency` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `zginv_product_elementid_zmc_element_id` FOREIGN KEY (`elementid`) REFERENCES `zmc_element` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `zginv_producttaxrelation`
--
ALTER TABLE `zginv_producttaxrelation`
  ADD CONSTRAINT `zginv_producttaxrelation_currencyid_zmc_currency_id` FOREIGN KEY (`currencyid`) REFERENCES `zmc_currency` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zginv_producttaxrelation_productid_zginv_product_id` FOREIGN KEY (`productid`) REFERENCES `zginv_product` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `zginv_producttaxrelation_taxid_zgfact_tax_id` FOREIGN KEY (`taxid`) REFERENCES `zgfact_tax` (`id`) ON DELETE CASCADE;
